...
public class Elefante extends Personagem {
    ...
    private void carregarSprites() {
        try {
            spritesCorrida = new Image[8];
            for (int i = 0; i < 8; i++) {
                URL imgURL = getClass().getResource("/Assets/Sprites/elefante-frame-" + (i + 1) + ".png");
                if (imgURL != null) {
            ...
            System.out.println("Erro ao carregar sprites do elefante: " + e.getMessage());
